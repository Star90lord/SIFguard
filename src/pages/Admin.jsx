...
export default function Admin() {
  ...
  const { currentUser, roleDefinition, switchRole, sites } = useApp();
    ...
    <AppShell title="Administration" subtitle="HSE Administration Console">
      <PageContainer className="space-y-4 sm:space-y-5">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5 sm:gap-3">
          <div className="p-3 sm:p-3.5 rounded-xl border border-[#D1D5DB] dark:border-[#263244] bg-white dark:bg-[#111827] shadow-xs">
            <div className="flex items-center justify-between text-xs text-slate-500 dark:text-[#94A3B8] mb-0.5">
              <span>Active Facilities</span>
              <Building2 size={14} className="text-slate-400 dark:text-[#94A3B8]" />
            </div>
            <span className="text-xl sm:text-2xl font-bold font-mono text-slate-900 dark:text-[#F8FAFC]">{totalSites}</span>
          ...
          <div className="p-3 sm:p-3.5 rounded-xl border border-[#D1D5DB] dark:border-[#263244] bg-white dark:bg-[#111827] shadow-xs">
            ...
            <span className="text-xl sm:text-2xl font-bold font-mono text-slate-900 dark:text-[#F8FAFC]">{totalReports}</span>
            <span className="text-[11px] text-slate-500 dark:text-[#94A3B8] block mt-0.5">Evaluated safety events</span>
          </div>

          <div className="p-3 sm:p-3.5 rounded-xl border border-amber-300 dark:border-amber-900/60 bg-amber-50/40 dark:bg-amber-950/20 shadow-xs">
            <div className="flex items-center justify-between text-xs text-amber-800 dark:text-amber-300 mb-0.5 font-semibold">
              <span>High Risk Reports</span>
              <AlertTriangle size={14} className="text-amber-600 dark:text-amber-400" />
            </div>
            <span className="text-xl sm:text-2xl font-bold font-mono text-amber-950 dark:text-amber-200">{highRiskCount}</span>
            <span className="text-[11px] text-amber-700/80 dark:text-amber-400/80 block mt-0.5">Severity classified</span>
          </div>

          <div className="p-3 sm:p-3.5 rounded-xl border border-red-300 dark:border-red-900/60 bg-red-50/40 dark:bg-red-950/20 shadow-xs">
            <div className="flex items-center justify-between text-xs text-red-800 dark:text-red-300 mb-0.5 font-bold">
              <span>SIF Precursors</span>
              <ShieldAlert size={14} className="text-red-600 dark:text-red-400" />
            </div>
            <span className="text-xl sm:text-2xl font-bold font-mono text-red-950 dark:text-red-200">{sifPrecursorCount}</span>
                ...
                <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-[#263244]">
                    <tr className="hover:bg-slate-50/70 dark:hover:bg-[#172033]">
                      ...
                      <td className="py-2.5 sm:py-3 px-3 text-slate-700 dark:text-[#CBD5E1] font-medium">Full Access</td>
                      <td className="py-2.5 sm:py-3 px-3 text-slate-600 dark:text-[#94A3B8]">HSE Operations Division</td>
                      <td className="py-2.5 sm:py-3 px-3">
                    ...
                    <tr className="hover:bg-slate-50/70 dark:hover:bg-[#172033]">
                      ...
                      <td className="py-2.5 sm:py-3 px-3 text-slate-700 dark:text-[#CBD5E1] font-medium">Operational Access</td>
                      <td className="py-2.5 sm:py-3 px-3 text-slate-600 dark:text-[#94A3B8]">Field Safety Monitoring</td>
                      <td className="py-2.5 sm:py-3 px-3">
                        <span className="inline-flex items-center gap-1 text-emerald-700 dark:text-emerald-400 font-semibold text-[11px]">
                          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> Active
                        </span>
                    ...
                    <tr className="hover:bg-slate-50/70 dark:hover:bg-[#172033]">
                      ...
                      <td className="py-2.5 sm:py-3 px-3 text-slate-600 dark:text-[#94A3B8]">Drilling & Rig Operations</td>
                      <td className="py-2.5 sm:py-3 px-3">
                        <span className="inline-flex items-center gap-1 text-emerald-700 dark:text-emerald-400 font-semibold text-[11px]">
                          <span className="w-1.5 h-1.5 rounded-full bg-emerald-500" /> Active
                        </span>
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-[#263244]">
                    {sites.map((site) => (
                      <tr key={site.id} className="hover:bg-slate-50/70 dark:hover:bg-[#172033]">
                        <td className="py-2.5 sm:py-3 px-3 font-bold text-slate-900 dark:text-[#F8FAFC]">{site.name}</td>
                        <td className="py-2.5 sm:py-3 px-3 font-mono text-slate-600 dark:text-[#94A3B8]">{site.code || site.id.toUpperCase()}</td>
                        <td className="py-2.5 sm:py-3 px-3 text-slate-600 dark:text-[#94A3B8]">{site.location}</td>
                        <td className="py-2.5 sm:py-3 px-3 text-slate-700 dark:text-[#CBD5E1]">{site.type}</td>
                        <td className="py-2.5 sm:py-3 px-3">
          ...
          <div className="space-y-4">
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 text-xs">
                {/* Risk Levels */}
                <div className="p-3 sm:p-3.5 rounded-lg bg-slate-50 dark:bg-[#070B12] border border-[#D1D5DB] dark:border-[#263244] space-y-1.5">
                  ...
                  <p className="text-[11px] text-slate-500 dark:text-[#94A3B8] pt-0.5">
          ...
          <div className="space-y-4">
            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
                <div className="p-2.5 sm:p-3 rounded-lg border border-[#D1D5DB] dark:border-[#263244] bg-slate-50 dark:bg-[#070B12]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 sm:gap-4 pt-1">
          ...
          <div className="p-3.5 sm:p-4 rounded-xl border border-[#D1D5DB] dark:border-[#263244] bg-white dark:bg-[#111827] shadow-xs space-y-2.5">
